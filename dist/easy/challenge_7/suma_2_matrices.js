...
function suma_vectores(objetivo, numeros) {
    ...
    let todo_mal_objetivo = restricciones(-1000, 1000, objetivo); /* [-1000 ; 1000] */
    let todo_mal_numeros = restricciones(2, 3 * Math.pow(10, 4), longitud); /* [2 ; (3 *10^4)] */
    if (todo_mal_objetivo || todo_mal_numeros)
        return null;
...
function buscar_pareja(numeros, objetivo, excluido) {
    ...
    while (minimo <= maximo) {
        ...
        let todo_mal_actual = restricciones(-1000, 1000, actual); /* [-1000; 1000] */
        if (todo_mal_actual)
            return null;
