...
const Problema_2_1 = require("../../../Busqueda.Binaria.01/11/Problema.2");
const Problema_1_1 = require("../../../Busqueda.Binaria.01/11/Problema.1");
test('pares valaidos. Test 1', () => {
    let numeros_1 = [55, 30, 5, 4, 2];
    let numeros_2 = [100, 20, 10, 10, 5];
    let salida = 2;
    let resultado = (0, Problema_1_1.pares_validos)(numeros_1, numeros_2);
...
test("obtener el menor numero. Test 1", () => {
    ...
    let salida = 1;
    let objetivo = 4;
    let resultado = (0, Problema_2_1.obtener_menor_numero)(entrada, objetivo);
