...
const Problema_1_1 = require("../../../Busqueda.Binaria.01/02/Problema.1");
const Problema_2_1 = require("../../../Busqueda.Binaria.01/02/Problema.2");
...
test(`indice_de_pico_array_montana test 1`, () => {
    let numeros = [0, 1, 0];
    let salida = 1;
    let resultado = (0, Problema_2_1.indice_de_pico_array_montana)(numeros);
    expect(resultado).toBe(salida);
});
