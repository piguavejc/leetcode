...
const challenges_7_1 = require("../../../easy/challenge_7");
const challenges_7_2 = require("../../../easy/challenge_7");
const datos_1 = require("./datos");
test("Suma. Test 1", () => {
    let numeros = [2, 7, 11, 15];
    let objetivo = 9;
    let salida = [1, 2];
    let resultado = (0, challenges_7_1.suma_vectores)(objetivo, numeros);
...
test("vector_especial. Test 1", () => {
    let numeros = [3, 5];
    let salidad = 2;
    let respuesta = (0, challenges_7_2.vector_especial)(numeros);
