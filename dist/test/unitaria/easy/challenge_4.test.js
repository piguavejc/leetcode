...
const challenges_4_1 = require("../../../easy/challenge_4");
const challenges_4_2 = require("../../../easy/challenge_4");
test("calculo raiz cuadrada test 1", () => {
  let numero = 8;
  let objetivo = 2;
  let salida = (0, challenges_4_1.calculo_raiz_cuadrada)(numero);
...
test("encontar letra mayor test 1", () => {
  let entrada = ["c", "f", "j"];
  let objetivo = "a";
  let resultado = (0, challenges_4_2.buscar_letra_mayor)(entrada, objetivo);
  let salida = "c";
