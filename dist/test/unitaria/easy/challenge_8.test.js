...
const challenges_8_1 = require("../../../easy/challenge_8");
const challenges_8_2 = require("../../../easy/challenge_8");
test("Numeros negativos. Test 1", () => {
    ...
    let salida = 8;
    let respuesta = (0, challenges_8_1.numeros_negativos)(entrada);
...
test("Numeros negativos. Test 6", () => {
    let entrada = [
        [
            16, 16, 16, 16, 15, 14, 14, 13, 13, 13, 12, -9, -9, -10, -10, -10, -10,
            -11, -11, -11,
        ],
        [
            15, 14, 14, 14, 14, 13, 13, 12, 11, 10, 9, -9, -10, -11, -12, -13, -14,
            -14, -14, -14,
        ],
        [
            15, 14, 14, 13, 12, 12, 12, 11, 10, 10, 9, -10, -10, -12, -12, -14, -14,
            -14, -14, -15,
        ],
        [
            15, 13, 13, 13, 11, 10, 9, 9, 8, 7, 6, -11, -12, -13, -14, -15, -15, -16,
            -17, -18,
        ],
        [
            14, 13, 12, 12, 11, 9, 8, 7, 7, 6, 5, -11, -12, -13, -15, -16, -16, -17,
            -17, -19,
        ],
        [
            14, 13, 12, 12, 10, 9, 7, 6, 6, 6, -10, -12, -12, -13, -16, -16, -17, -18,
            -18, -20,
        ],
        [
            13, 12, 12, 11, 9, 9, 7, 5, 5, 5, -10, -13, -13, -13, -17, -18, -19, -20,
            -20, -20,
        ],
        [
            13, 12, 11, 11, 8, 7, 7, 4, 3, 2, -10, -14, -15, -16, -18, -18, -20, -20,
            -20, -20,
        ],
        [
            13, 12, 10, 9, 7, 7, 7, 4, 3, 1, -11, -15, -15, -16, -18, -19, -20, -20,
            -20, -20,
        ],
        [
            12, 12, 9, 9, 7, 7, 7, 4, 2, 0, -11, -15, -15, -17, -19, -20, -20, -20,
            -20, -20,
        ],
        [
            12, 11, 8, 7, 7, 6, 6, 3, 2, 0, -11, -15, -15, -18, -20, -20, -20, -20,
            -20, -20,
        ],
        [
            12, 11, 8, 6, 6, 5, 4, 2, 1, -1, -11, -16, -17, -19, -20, -20, -20, -20,
            -20, -20,
        ],
        [
            11, 10, 8, 6, 6, 5, 3, 1, 0, -1, -12, -18, -18, -20, -20, -20, -20, -20,
            -20, -20,
        ],
        [
            11, 10, 7, 5, 4, 4, 2, 0, 0, -1, -13, -18, -19, -20, -20, -20, -20, -20,
            -20, -20,
        ],
        [
            11, 10, 7, 4, 4, 4, 2, 0, 0, -2, -13, -19, -19, -20, -20, -20, -20, -20,
            -20, -20,
        ],
        [
...
test("Adivinar numero en una matriz. Test 1", () => {
    ...
    let objetivo = 3;
    let respuesta = (0, challenges_8_2.buscar_matriz)(entrada, objetivo);
    let salida = true;
    expect(respuesta).toBe(salida);
});
