...
const challenges_1_1 = require("../../../easy/challenge_1");
const challenges_1_2 = require("../../../easy/challenge_1");
test("adivinar numero 1", () => {
    let entrada = [-1, 0, 3, 5, 9, 12];
    let salida = -1;
    let objetivo = 2;
    let resultado = (0, challenges_1_1.buscar_objetivo)(entrada, objetivo);
...
test("juego de adivinanza. test 1", () => {
    let numero = 10;
    let objetivo = 6;
    let resultado = (0, challenges_1_2.juego_adivinanza)(numero, objetivo);
