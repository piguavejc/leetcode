import { es_cuadrado_perfecto } from "../../../Busqueda.Binaria.01/03/Problema.1";
import { encontar_valor_distancia } from "../../../Busqueda.Binaria.01/03/Problema.2";
...
test("encontar valor distancia test 1", () => {
    ...
    let salida: number = encontar_valor_distancia(vector_1, vector_2, distancia);
...
test("encontar valor distancia test 5", () => {
    let vector_1 = [
        ...
        -659, 865, 102, -564, -452, 554, -320, 229, 36, 722, -478, -247, -307, -304, -767, -404, -519, 776, 933, 236,
        596, 954, 464,
    ];
    let vector_2 = [
        817, 1, -723, 187, 128, 577, -787, -344, -920, -168, -851, -222, 773, 614, -699, 696, -744, -302, -766, 259,
        203, 601, 896, -226, -844, 168, 126, -542, 159, -833, 950, -454, -253, 824, -395, 155, 94, 894, -766, -63, 836,
        -433, -780, 611, -907, 695, -395, -975, 256, 373, -971, -813, -154, -765, 691, 812, 617, -919, -616, -510, 608,
