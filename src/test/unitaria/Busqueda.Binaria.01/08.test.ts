...
test("Numeros negativos. Test 1", () => {
  ...
  let salida: number = 8;
  let respuesta: number = numeros_negativos(entrada);
...
test("Adivinar numero en una matriz. Test 1", () => {
  ...
  let respuesta: boolean = buscar_matriz(entrada, objetivo);
