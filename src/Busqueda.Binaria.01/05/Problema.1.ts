function encontrar_version_mala(numero: number): number {
    ...
    let todo_mal: boolean = restriccion(1, Math.pow(2, 31) - 1, numero, resultado); /* [1 ; (2^31 - 1)] */
...
function restriccion(minimo: number, maximo: number, numero: number, objetivo: number): boolean {
