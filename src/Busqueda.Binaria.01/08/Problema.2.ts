function buscar_matriz(numeros: number[][], objetivo: number): boolean {
    ...
    let todo_mal_objetivo: boolean = restriccion_1(objetivo, Math.pow(10, 4)); /* [objetivo ; 10^4]  */
...
function buscar_objetivo(numeros: number[], objetivo: number): boolean {
    ...
    while (minimo <= maximo) {
        ...
        let todo_mal_actual: boolean = restriccion_1(-Math.pow(10, 4), actual); /* [-10^4 ; actual] */
