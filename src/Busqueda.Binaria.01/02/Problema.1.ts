function encontrar_objetivo(numeros: number[], objetivo: number): number {
    ...
    let todo_mal_objetivo: boolean = restriccion(objetivo, -Math.pow(10, 4), Math.pow(10, 4)); // [-10^4 ; 10^4] intervalo cerrado
    ...
    while (minimo <= maximo) {
        ...
        let todo_mal_actual: boolean = restriccion(actual, -Math.pow(10, 4), Math.pow(10, 4)); // [-10^4 ; 10^4] intervalo cerrado
