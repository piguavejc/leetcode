function calculo_raiz_cuadrada(numero: number): number {
    ...
    let condicion_numero: boolean = restriccion_numero(0, Math.pow(2, 31) - 1, numero); /* [0 ; (2^31 - 1)] */
...
function restriccion_numero(minimo: number, maximo: number, numero: number): boolean {
